...
function Favorites(){
    return (
        <section className="bg-lime-900 pl-20 py-5">
            ...
            <div className="flex gap-10 overflow-x-auto pb-2 cursor-grab">
                <ItemCard imageURL="https://images.unsplash.com/photo-1552332386-f8dd00dc2f85?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" name={"TACOS AL PASTOR"} price={"7.99"}/>
